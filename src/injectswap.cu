...
namespace QuaSARQ {
        ...
        const   size_t          num_qubits_padded)
    {
        ...
        pivots[1] = (qubit_word & q_mask) ? 1 : 0;
    }
        ...
        const   size_t              num_qubits_padded) 
    {
        for_parallel_x(w, num_words_minor) { 
            ...
            const pivot_t is_commuting = pivots[1];
    ...
    void Simulator::inject_swap(const qubit_t& qubit, const cudaStream_t& stream) {
    ...
    void MeasurementChecker::check_inject_swap(const Tableau& other_input, const pivot_t* other_pivots, const size_t& num_pivots) {
        ...
        bool other_commuting_bit = d_compact_pivots[1];
