...
void Equivalence::check() {
    ...
    num_partitions = tableau.alloc(num_qubits, winfo.max_window_bytes, false, false, true, estimated_num_partitions);
    other_num_partitions = other_tableau.alloc(other_num_qubits, other_wininfo.max_window_bytes, false, false, true, estimated_num_partitions);
