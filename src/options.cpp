...
namespace QuaSARQ {
    ...
    INT_OPT opt_max_gpu_memory("max-gpu-memory", "cap the GPU pool in MB (0: take what is free)", 0, INT32R(0, INT32_MAX));
    ...
    void Options::initialize() {
        ...
        max_gpu_memory = opt_max_gpu_memory;
